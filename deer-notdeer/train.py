...
def main():
    ...
    Path.mkdir(Path("./model_checkpoints"), parents=True, exist_ok=True)

    callbacks = [
        ModelCheckpoint(filepath="./model_checkpoints", save_best_only=True, save_weights_only=False, monitor="val_loss")
    ]
